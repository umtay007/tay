              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="amount" className="text-white">
                    Amount (USD) {(paymentMethod === "cashapp" || paymentMethod === "wallets") && "(If somebody did)"}
                  </Label>
                  <Input
                    id="amount"
                    type="text"
                ...
                <div className="bg-black/20 p-4 rounded-xl space-y-3">
                  ...
                  <ul className="space-y-2 text-sm text-white list-disc pl-5">
                    ...
                    <li>
                      You must provide a screen recording of you sending the payment (Discord/Telegram chats must be
                      shown within the screen recording)
                    </li>
