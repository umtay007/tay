...
const socials = [
  {
    name: "Discord",
    url: "https://discord.com/users/1346646019693215744",
    icon: (
  ...
  },
  {
    ...
    hoverColor: "hover:text-[#E4405F] hover:border-[#E4405F]",
  },
  {
    name: "TikTok",
  ...
  },
  {
    ...
    hoverColor: "hover:text-[#0088cc] hover:border-[#0088cc]",
  },
  {
    name: "NameMC",
    url: "https://namemc.com/profile/yourusername",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M3 3h8v8H3V3zm0 10h8v8H3v-8zm10 0h8v8h-8v-8zm0-10h8v8h-8V3z" />
      </svg>
    ),
    hoverColor: "hover:text-[#4CAF50] hover:border-[#4CAF50]",
  },
]
